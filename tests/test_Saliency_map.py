...
image_path = "C:/Users/GH/Desktop/backend/Image-Retargeting/data/input/img_6.png"
...
def combine_maps(gradient_map, saliency_map, depth_map):
    ...
    # Combine the maps
    energy_map = ( saliency_map + depth_map) / 2
...
img_new = img_rgb()
img_new, energy = SeamCarving(is_connected=True)(img_new, energy_map, 256, 1)
